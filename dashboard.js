...
function getMainSessionPayload() {
    ...
    return {
        ...
        qrPausedReason: appState.getQrPausedReason ? appState.getQrPausedReason() : null,
        lastError: appState.getLastError ? appState.getLastError() : null,
        lastErrorAt: appState.getLastErrorAt ? appState.getLastErrorAt() : null,
        lastConnectedAt: appState.getLastConnectedAt ? appState.getLastConnectedAt() : null,
        badMacCount: appState.getBadMacCount ? appState.getBadMacCount() : 0,
